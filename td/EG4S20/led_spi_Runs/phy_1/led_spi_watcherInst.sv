module CW_TOP_WRAPPER(jtdi, jtck, jrstn, jscan, jshift, jupdate, jtdo, trig_clk, bus_din, wt_ce, wt_en, wt_addr);
	...
	localparam BUS_DIN_NUM = 2;
	localparam BUS_CTRL_NUM = 12;
	localparam integer BUS_WIDTH[0:1] = {1,1};
	localparam integer BUS_DIN_POS[0:1] = {0,1};
	localparam integer BUS_CTRL_POS[0:1] = {0,6};
