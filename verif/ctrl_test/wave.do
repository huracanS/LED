...
add wave -noupdate -expand -group LED_send /tb_led_ctrl_top/uut/u_LED_send/cac_done
add wave -noupdate -expand -group LED_send -radix unsigned /tb_led_ctrl_top/uut/u_LED_send/cac_result
...
add wave -noupdate -expand -group LED_send /tb_led_ctrl_top/uut/u_LED_send/sdo_2
...
add wave -noupdate -expand -group fifo_fsm -radix unsigned /tb_led_ctrl_top/uut/u_LED_send/cac_result
...
WaveRestoreCursors {{Cursor 1} {282966145 ps} 0}
...
update
WaveRestoreZoom {94552 ps} {63714406 ps}
